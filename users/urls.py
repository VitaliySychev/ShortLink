...
urlpatterns = [
    ...
    path('password-reset_complete/', authViews.PasswordResetCompleteView.as_view(template_name='users/password-reset_complete.html'), name='password-reset_complete'),
    path('password_reset_confirm/', authViews.PasswordResetConfirmView.as_view(template_name='users/password_reset_confirm.html'), name='password_reset_confirm'),
